      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        <div class="card o-hidden border-0 shadow-lg">
          <div class="card-body p-0">
            ...
            <div class="row">
              <!-- Kiri: Logo, Nama Aplikasi, dan Gambar Login -->
              ...
              <!-- Kanan: Form Login -->
              <div class="col-lg-6 login-container d-flex align-items-center">
                <div class="p-5 form-container w-100">
                  ...
                  <form class="user">
                    ...
                    <div class="form-group input-group-custom">
                      ...
                      <img src="assets/login/img/passwordIcon.jpg" class="input-icon" alt="Lock Icon">
                    </div>
